...
contract CentralizedArbitrator is Arbitrator {
     ...
     */
    function arbitrationCost(bytes memory _extraData) public override view returns(uint fee) {
     ...
     *  @return fee Amount to be paid.
     */
    function appealCost(uint _disputeID, bytes memory _extraData) public override view returns(uint fee) {
     ...
     */
    function createDispute(uint _choices, bytes memory _extraData) public override payable returns(uint disputeID)  {
     ...
     */
    function currentRuling(uint _disputeID) public override view returns(uint ruling) {
